...
bool    ImGui_ImplOpenGL3_CreateDeviceObjects()
{
    ...
    const GLchar* vertex_shader_glsl_120 =
        ...
        "attribute vec2 PositionComponent;\n"
        "attribute vec2 UV;\n"
        ...
        "    Frag_UV = UV;\n"
        "    Frag_Color = Color;\n"
        "    gl_Position = ProjMtx * vec4(PositionComponent.xy,0,1);\n"
        "}\n";

    const GLchar* vertex_shader_glsl_130 =
        "uniform mat4 ProjMtx;\n"
        "in vec2 PositionComponent;\n"
        "in vec2 UV;\n"
        "in vec4 Color;\n"
        "out vec2 Frag_UV;\n"
        "out vec4 Frag_Color;\n"
    ...
    const GLchar* vertex_shader_glsl_300_es =
        ...
        "layout (location = 0) in vec2 PositionComponent;\n"
    ...
    bd->AttribLocationVtxPos = (GLuint)glGetAttribLocation(bd->ShaderHandle, "PositionComponent");
