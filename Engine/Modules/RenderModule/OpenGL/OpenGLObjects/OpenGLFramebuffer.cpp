...
{
    LT_LOGI("RenderModule::OpenGLFramebuffer", "Destruct");
...
{
    LT_LOGI("RenderModule::OpenGLFramebuffer", "add color attachment");
...
{
    LT_LOGI("RenderModule::OpenGLFramebuffer", "add Depth attachment");
    if (asTexture)
    {
