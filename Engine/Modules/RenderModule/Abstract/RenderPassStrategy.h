...
namespace RenderModule
{
	...
	public:
		IRenderPassStrategy() : m_resourceManager(GCM(ResourceModule::ResourceManager))
		{
		}
		...
		void resize(const std::pair<int, int>& renderSize)
		{
			if (m_framebuffer)
			{
				m_framebuffer->resize(renderSize.first, renderSize.second);
			}
		}
