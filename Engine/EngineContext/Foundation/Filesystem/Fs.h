...
public:
  ...
  static FsResult writeTextFile(const std::string &filePath,
                                const std::string &content);
  static FsResult appendTextFile(const std::string &filePath,
                                 const std::string &content);
  ...
  static FsResult moveFileToDirectory(const std::string &filePath,
                                      const std::string &destinationDir);
  static FsResult createDirectory(const std::string &dirPath);
  static FsResult createEmptyFile(const std::string &dirPath,
                                  const std::string &fileName);

  static std::vector<std::string>
  getDirectoryContents(const std::string &dirPath, const SearchFilter &filter);

  static FsResult copyAbsolutePathToClipboard(const std::string &path);
  static FsResult copyRelativePathToClipboard(const std::string &path,
                                              const std::string &base);
};
} // namespace EngineCore::Foundation
