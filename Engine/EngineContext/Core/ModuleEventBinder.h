...
public:
    ...
    void bind(TClass* instance, void (TClass::*method)(const TEvent&))
    {
        auto sub = GCEB().subscribe<TEvent>(
            [instance, method](const TEvent& e) { (instance->*method)(e); });
